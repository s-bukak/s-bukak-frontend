...
const MessageList = ({style}) => {
    ...
    return (
        <div className="flex flex-col items-center w-full h-full mt-2">
            <div
                className="flex flex-col justify-between w-full h-full bg-white rounded-2xl border border-gray-400 p-4">
                <div
                    ...
                    >
                        {chatList.length > 0 ? (
                            ...
                            {comment.createdAt}
                                                ...
                                                <div
                                                    className="w-10 h-10 rounded-full overflow-hidden border-2 border-gray-200 ml-3">
                                            ...
                                            <>
                                                <div
                                                    className="w-10 h-10 rounded-full overflow-hidden border-2 border-gray-200 mr-3">
                                                    <img
                                                        src={
                                                            comment.isAnonymous
                                                                ? anonymous
                            ...
                            <span className="text-sm font-semibold">
                              {comment.isAnonymous ? "익명" : comment.username}
                                                    ...
                                                    <div className="flex flex-row">
                                                        <div
                                                            className="bg-gray-100 text-gray-700 p-2.5 rounded-lg text-sm break-words">
                                                            {comment.content}
                                                        </div>
                ...
                <div className="flex items-center w-full p-1 pl-2.5 rounded-xl bg-gray-100 mt-4 border border-gray-400">
                    ...
                    <input
                        ...
                        placeholder={
                            isTokenValid()
                                ? teamInfo
                                    ? `${teamInfo.name} 선수들에게 응원 메세지를 남겨보세요!` : homePlaceHolder
                                : "로그인이 필요한 기능입니다."
