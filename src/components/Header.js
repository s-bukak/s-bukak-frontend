...
const Header = () => {
  const [activeSportTab, setActiveSportTab] =
    useRecoilState(activeSportTabState); // Recoil 상태 사용
  ...
  return (
    <div>
      ...
      {showTeamLogos && (
        ...
        >
          <div
            className={`flex space-x-3 ${activeSportTab === "basketball" ? "py-4" : "py-3"} min-w-[max-content]`}
          >
            {teamNames.map((team, index) => (
              ...
              >
                <img
                  ...
                  alt={team}
                  style={{
                    height: activeSportTab === "soccer" ? "60px" : "52px",
                    width: "auto",
                  }}
                />
              </button>
